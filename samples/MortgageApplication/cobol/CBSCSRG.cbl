      ...
      * 01 WS-PRINT PIC X(30) VALUE 'YOU ARE ALREADY REGISTERED'.
        01 WS-ACCOUNT-NAME1 PIC X(50).
      * 01 WS-PRINT1 PIC X(23) VALUE 'REGISTERED SUCESSFUL'.
        01 WS-PRINT1 PIC X(20) VALUE 'REGISTERED SUCESSFUL'.
      * 01 WS-PRINT1 PIC X(23) VALUE 'YOU ARE ONBOARD'.
