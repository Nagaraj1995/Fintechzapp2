      ...
      *| DATE GENERATED: 03/07/2023 01:41                              |
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 ZUT00000001.
            5 PIC X(10) DISPLAY VALUE '2022-08-01'.
          3 ZUT00000002.
            5 PIC X(8) DISPLAY VALUE '03.39.10'.
          3 ZUT00000003.
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 ZUT0000000F.
            5 PIC X(10) DISPLAY VALUE '2022-08-01'.
          3 ZUT00000010.
            5 PIC X(8) DISPLAY VALUE '03.41.38'.
          3 ZUT00000011.
            5 PIC X(10) VALUE X'D6D3C9E5C9C140C9E240'.
            5 PIC X(10) VALUE X'C1D3D9C5C1C4E840D9C5'.
            5 PIC X(10) VALUE X'C7C9E2E3C5D9C5C40000'.
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT0000001A.
            ...
            5 PIC X(5) DISPLAY VALUE 'MAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000013 PIC X(50) OCCURS 2.
          3 ZUT00000015 PIC -9(9) OCCURS 2.
          3 ZUT00000017 PIC X(10) OCCURS 2.
          3 ZUT00000019 PIC X(8) OCCURS 2.
          3 ZUT0000001B PIC X(200) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           ...
           ELSE
             MOVE CUSTOMER-NAME OF CSRGRES OF CSRGRES OF DFHCOMMAREA
           TO ZUT00000013(1)
             MOVE ZUT0000000E TO ZUT00000013(2)
           ...
           ELSE
             MOVE SYS-DATE OF CSRGRES OF CSRGRES OF DFHCOMMAREA TO
           ZUT00000017(1)
             MOVE ZUT0000000F TO ZUT00000017(2)
           ...
           ELSE
             MOVE SYS-TIME OF CSRGRES OF CSRGRES OF DFHCOMMAREA TO
           ZUT00000019(1)
             MOVE ZUT00000010 TO ZUT00000019(2)
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT0000001B(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 100
               MOVE ZUT00000011(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT0000001B(2)(AZ-J:2)
             END-PERFORM
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 ZUT0000001D.
            5 PIC X(10) DISPLAY VALUE '2022-08-01'.
          3 ZUT0000001E.
            5 PIC X(8) DISPLAY VALUE '08.21.55'.
          3 ZUT0000001F.
            5 PIC X(10) VALUE X'D6D3C9E5C9C140C9E240'.
            5 PIC X(10) VALUE X'C1D3D9C5C1C4E840D9C5'.
            5 PIC X(10) VALUE X'C7C9E2E3C5D9C5C40000'.
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT00000028.
            ...
            5 PIC X(5) DISPLAY VALUE 'MAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000021 PIC X(50) OCCURS 2.
          3 ZUT00000023 PIC -9(9) OCCURS 2.
          3 ZUT00000025 PIC X(10) OCCURS 2.
          3 ZUT00000027 PIC X(8) OCCURS 2.
          3 ZUT00000029 PIC X(200) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           ...
           ELSE
             MOVE CUSTOMER-NAME OF CSRGRES OF CSRGRES OF DFHCOMMAREA
           TO ZUT00000021(1)
             MOVE ZUT0000001C TO ZUT00000021(2)
           ...
           ELSE
             MOVE SYS-DATE OF CSRGRES OF CSRGRES OF DFHCOMMAREA TO
           ZUT00000025(1)
             MOVE ZUT0000001D TO ZUT00000025(2)
           ...
           ELSE
             MOVE SYS-TIME OF CSRGRES OF CSRGRES OF DFHCOMMAREA TO
           ZUT00000027(1)
             MOVE ZUT0000001E TO ZUT00000027(2)
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000029(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 100
               MOVE ZUT0000001F(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000029(2)(AZ-J:2)
             END-PERFORM
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          3 ZUT0000002A.
            ...
            5 PIC X(44) DISPLAY VALUE SPACES.
          3 ZUT0000002B.
            5 PIC X(10) DISPLAY VALUE '2022-11-17'.
          3 ZUT0000002C.
            5 PIC X(8) DISPLAY VALUE '05.53.20'.
          3 ZUT0000002D.
            5 PIC X(10) VALUE X'D6D3C9E5C9C140C9E240'.
            5 PIC X(10) VALUE X'C1D3D9C5C1C4E840D9C5'.
            5 PIC X(10) VALUE X'C7C9E2E3C5D9C5C40000'.
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT00000036.
            ...
            5 PIC X(5) DISPLAY VALUE 'MAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT0000002F PIC X(50) OCCURS 2.
          3 ZUT00000031 PIC -9(9) OCCURS 2.
          3 ZUT00000033 PIC X(10) OCCURS 2.
          3 ZUT00000035 PIC X(8) OCCURS 2.
          3 ZUT00000037 PIC X(200) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           ...
           ELSE
             MOVE CUSTOMER-NAME OF CSRGRES OF CSRGRES OF DFHCOMMAREA
           TO ZUT0000002F(1)
             MOVE ZUT0000002A TO ZUT0000002F(2)
           ...
           ELSE
             MOVE SYS-DATE OF CSRGRES OF CSRGRES OF DFHCOMMAREA TO
           ZUT00000033(1)
             MOVE ZUT0000002B TO ZUT00000033(2)
           ...
           ELSE
             MOVE SYS-TIME OF CSRGRES OF CSRGRES OF DFHCOMMAREA TO
           ZUT00000035(1)
             MOVE ZUT0000002C TO ZUT00000035(2)
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000037(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 100
               MOVE ZUT0000002D(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000037(2)(AZ-J:2)
             END-PERFORM
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '0e6d4bf3-fca1-404c-bcf7-ae21bca20386'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
